        ...
        <div class="col-lg-5 col-md-7 col-sm-10">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white text-center py-4 border-bottom">
                    ...
                    <p class="text-muted small">Silakan ubah nama kategori sesuai keinginan</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('kategoris.update', $kategori->KategoriId) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Nama" id="Nama" class="form-control rounded-3 py-2 px-3 border border-2 border-primary" value="{{ $kategori->Nama }}" required>
                        </div>
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('kategoris.index') }}" class="btn btn-outline-secondary rounded-3 px-4 py-2">Batal</a>
                            <button type="submit" class="btn btn-primary rounded-3 px-4 py-2">Update</button>
                        </div>
                    </form>
                </div>
            </div>
