...
<div class="container">
    ...
    <!-- Pencarian dan Tambah Supplier -->
    <div class="mb-3 d-flex justify-content-between align-items-center">
        <input type="text" class="form-control w-50" id="search-input" placeholder="Cari supplier...">
        ...
        <div class="table-container mt-3">
            <table class="table table-striped table-hover">
                ...
                <tbody id="supplier-table-body">
                    @foreach ($suppliers->sortByDesc('SupplierId') as $supplier)
                        <tr>
                            ...
                            <td>    
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    <form action="{{ route('suppliers.destroy', $supplier->SupplierId) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus supplier ini?');" class="d-inline">
                                        @csrf
                                        @method('DELETE')
