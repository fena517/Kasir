    ...
    <div class="container form-container mt-3"> <!-- Reduced margin-top here -->
        <div class="card">
            ...
            <div class="card-body p-4">
                <form action="{{ route('units.update', $unit->UnitId) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-12 mb-3">
                            <label for="Nama" class="form-label">Nama</label>
                            <input type="text" name="Nama" id="Nama" class="form-control" value="{{ $unit->Nama }}" placeholder="Masukkan Kategori" required>
                        </div>
                    </div>
